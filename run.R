...
download.file(fileUrl, destfile = "./run_analysis.R/projectData_getCleanData.zip")

## step 2: unzip data
listZip <- unzip("./run_analysis.R/projectData_getCleanData.zip", exdir = "./run_analysis.R")
...
write.table(groupData,file = "Tidy_main.txt" , row.names = FALSE)